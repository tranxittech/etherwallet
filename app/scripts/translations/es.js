...
tx_notFound_4               : 'Por favor usa el desplegable en la parte superior derecha y selecciona un nodo ETH diferente (ej. `ETH (Etherscan.io)` o `ETH (Infura.io)` o `ETH (phicoinwallet)`) y comprueba de nuevo.',
...
/* Header */
MEW_Warning_1               : 'Comprueba siempre la URL antes de acceder a tu cartera o crear una cartera nueva. ¡Ten cuidado con los sitios falsos (viceshing)! ',
...
MYWAL_Content_3             : 'Si en el futuro quieres utilizar esta cartera con phicoinwallet CX, tendrás que volver a añadirla manualmente utilizando Clave Privada/JSON y contraseña. ',
...
NODE_Warning                : 'Tu nodo debe ser HTTPS para poder conectar a él desde phicoinwallet.com. Para conectarte a cualquier nodo, puedes [descargar el repositorio de phicoinwallet y ejecutarlo localmente](https://github.com/kvhnuke/etherwallet/releases/latest). También puedes conseguir un certificado SSL gratuito a través de [Let\'s Encrypt](https://letsencrypt.org/)',
...
ADD_Ledger_0a               : 'Volver a abrir phicoinwallet en una conexión segura (SSL) ',
ADD_Ledger_0b               : 'Volver a abrir phicoinwallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Volver a abrir phicoinwallet en una conexión segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Volver a abrir phicoinwallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ERROR_28                        :  '(error_29) **Necesitas tu archivo Keystore/JSON y la contraseña** (o clave privada) para acceder a esta cartera en el futuro. Por favor ¡guárdala y respáldala externamente! No hay modo de recuperar una cartera si no la guardas. Lee la [página de ayuda](https://www.phicoinwallet.com/#help) para instrucciones. You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ', // 28
...
ERROR_35                        :  '(error_36) Input address is not checksummed. <a href="https://phicoinwallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> More info</a>Input address is not checksummed. <a href="https://phicoinwallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer">What does that mean?</a>', // 35
...
HELP_2b_Title               : '2b) ¿Cómo almaceno con seguridad/sin conexión/en frío con phicoinwallet? ',
...
HELP_3_Desc_3               : 'Ve a la página "Ver Información de las Carteras" de phicoinwallet.com. ',
...
HELP_4CX_Title              : '4) ¿Cómo envío ether utilizando phicoinwallet CX? ',
...
HELP_5_Title                : '5) ¿Cómo ejecuto phicoinwallet.com sin conexión/localmente? ',
HELP_5_Desc_1               : 'Puedes ejecutar phicoinwallet.com en tu equipo en lugar de desde los servidores de GitHub. Puedes generar una cartera totalmente sin conexión y enviar transacciones desde la página "Transacción sin conexión". ',
HELP_5_Desc_7               : 'phicoinwallet.com is now running entirely on your computer. ',
HELP_5_Desc_8               : 'Por si no tienes costumbre, es necesario guardar la carpeta completa para ejecutar la página web, no solamente `index.html`. No modifiques ni muevas nada dentro de la carpeta. Si estás guardando una copia del repositorio phicoinwallet para el futuro, recomendamos guardar únicamente el fichero ZIP para poder estar seguro de que el contenido permanezca intacto. ',
HELP_5_Desc_9               : 'Debido a que estamos constantemente actualizando phicoinwallet.com, recomendamos que actualices periódicamente tu versión guardada del repositorio. ',
...
HELP_8_Desc_1               : 'phicoinwallet no es una cartera web. No tienes un login y nunca se graba nada en nuestros servidores. You don\'t have a login and nothing ever gets saved to our servers. Simplemente es una interfaz que te permite interactuar con la cadena de bloques. ',
HELP_8_Desc_2               : 'Si phicoinwallet.com desapareciera, tendrías que encontrar otra manera de poder hacer lo que haces con nosotros (como por ejemplo obtener geth o Ethereum Wallet / Mist). Pero no necesitarías retirar tus ether de phicoinwallet porque no están en phicoinwallet. Están en la cartera que hayas generado a través de nuestro sitio. ',
...
HELP_8CX_Desc_2             : 'Dicho esto, es **muy importante** que respaldes toda tu información para todas las nuevas carteras generadas con phicoinwallet CX. De este modo, si algo le ocurre a phicoinwallet CX o a tu equipo, seguirás teniendo toda la información necesaria para poder acceder a tus ether. Ver la pregunta #2a sobre cómo respaldar tus carteras. ',
HELP_8CX_Desc_3             : 'Si por algún motivo phicoinwallet CX desaparece de Chrome Store, puedes encontrar el código fuente en Github y cargarlo manualmente. Ver #5 más arriba. ',
...
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experments) believe in window.crypto. In addition, phicoinwallet.com can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Seguridad - phicoinwallet CX ',
...
HELP_SecCX_Desc_6           : 'Si cifráramos estos ítems, sería necesario que introduzcas una contraseña cada vez que quisieras comprobar el saldo de tu cuenta o vizualizar los alias. Si esto te preocupa, te recomendamos que utilices phicoinwallet.com en lugar de esta extensión de Chrome. ',
...
HELP_Sec_Desc_2             : 'Hemos estado funcionando desde agosto de 2015. Si buscas ["phicoinwallet" en reddit](https://www.reddit.com/search?q=phicoinwallet), puedes encontrar numerosas personas que nos utilizan con gran éxito. ',
...
HELP_Sec_Desc_4             : 'Comprueba la URL -- Este sitio se sirve a través de GitHub y puedes ver el código fuente aquí: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) a [https://www.phicoinwallet.com](https://www.phicoinwallet.com). ',
