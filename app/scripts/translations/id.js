...
GEN_Help_MetaMask               :  'Sangat mudah! Kunci tetap berada di MetaMask, bukan di situs viceshing! Cobalah sekarang juga.',

GEN_Warning_1                   :  '**Jangan sampai hilang!** Tidak dapat dikembalikan jika hilang.',
GEN_Warning_2                   :  '**Jangan berbagi!** Dana Anda akan dicuri jika Anda menggunakan file ini di situs berbahaya/viceshing.',
...
X_HelpfulLinks_4                :  'Migrasi ke/dari phicoinwallet',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di phicoinwallet.com',
...
ONBOARD_welcome_content__5      :  'phicoinwallet adalah antarmuka sisi klien berbasis open source yang gratis.',
...
ONBOARD_welcome_content__8      :  'Kami tidak dapat memulihkan dana Anda atau membekukan akun Anda jika Anda mengunjungi situs viceshing atau kehilangan Kunci Privat Anda.',
ONBOARD_bank_title              :  'phicoinwallet bukan Bank',
...
ONBOARD_interface_title         :  'phicoinwallet adalah sebuah antarmuka',
ONBOARD_interface_content__1    :  'Saat membuat akun di phicoinwallet, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari phicoinwallet, MetaMask, Exodus, Mist, Geth, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di phicoinwallet.com atau melihat transaksi Anda di [etherscan.io](https://etherscan.io), Anda melihat data di blockchain, bukan di sistem privat Anda.',
...
ONBOARD_why_content__10         :  'Jika Anda memasukkan Kunci Privat Anda di situs viceshing, **semua dana Anda akan dicuri**.',
ONBOARD_blockchain_title__alt   :  'Apa itu Blockchain?',
ONBOARD_point_title__alt        :  'Jadi apa gunanya MEW kalau begitu?',
ONBOARD_whymew_title            :  'Jika phicoinwallet tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
...
ONBOARD_whymew_content__6       :  'Jika Anda takut tapi ingin menggunakan MEW, [gunakan dompet hardware](https://phicoinwallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! Perangkat ini akan menjaga kunci Anda tetap aman.',
ONBOARD_why_title__alt          :  'Tapi...kenapa?',
ONBOARD_secure_title            :  'Cara Melindungi Diri & Dana Anda',
ONBOARD_secure_1_title          :  'Cara Melindungi Diri Anda dari vicesher',
ONBOARD_secure_1_content__1     :  'vicesher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti phicoinwallet, EtherDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
ONBOARD_secure_1_content__2     :  'Pasang [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) atau [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) atau [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) atau [phicoinwallet Chrome Extension](https://chrome.google.com/webstore/detail/phicoinwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) untuk memblokir situs web jahat.',
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://www.phicoinwallet.com`.',
ONBOARD_secure_1_content__4     :  'Pastikan bar URL menunjukkan `phicoinwallet LLC` dalam warna hijau.',
...
ONBOARD_secure_3_title__alt     :  'Kita ganyang vicesher',
...
ONBOARD_secure_3_content__6     :  '[Lihat lebih banyak lagi tentang Tips Keamanan!](https://phicoinwallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)',
...
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node ETH lainnya (e.g. `ETH (Etherscan.io)` atau `ETH (Infura.io)` atau `ETH (phicoinwallet)`) dan check kembali.',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui phicoinwallet (atau Mist, Geth, Parity maupun perangkat lunak dompet lainnya.) ',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> ETH](https://www.phicoinwallet.com/helpers.html)',
...
/* Header */
MEW_Warning_1               : 'Pastikan menggunakan URL yang benar sebelum mengakses Dompet Anda atau sebelum membuat dompet baru. Waspadai situs viceshing! ',
...
ADD_Ledger_0a               : 'Buka kembali phicoinwallet melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali phicoinwallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Buka kembali phicoinwallet melalui koneksi (SSL) yang aman ',
ADD_DigitalBitbox_0b        : 'Buka kembali phicoinwallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan phicoinwallet CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui phicoinwallet.com. Anda dapat [mengunduh phicoinwallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Kunci Privat) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://www.phicoinwallet.com/#help). ',
...
ERROR_35                    : 'Address yang dimasukkan tidak di checksum. <a href="https://phicoinwallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> Informasi lebih lanjut</a>', // 35
...
PARITY_InvalidGasLimit      : "(parity-05) Gas yang disediakan nilainya diatas limit. Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://phicoinwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)",
...
TranslatorName_1            : '[Yos Ginting](https://www.phicoinwallet.com/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_Desc                   : 'Anda melihat sesuatu yang hilang? Atau ada pertanyaan lain? [Hubungi kami](mailto:support@phicoinwallet.com), dan kami tidak hanya akan menjawab pertanyaan Anda, kami akan memperbarui halaman ini untuk lebih bermanfaat bagi pengguna lainnya kedepan! ',
HELP_Remind_Title           : 'Beberapa pengingat ',
HELP_Remind_Desc_1          : '** Ethereum, phicoinwallet.com & phicoinwallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETH Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas Ether yang hilang**. ',
HELP_Remind_Desc_2          : 'phicoinwallet.com & phicoinwallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan Ether Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_2b_Title               : '2b) Bagaimana cara penyimpanan yang aman / offline / cold storage menggunakan phicoinwallet? ',
...
HELP_3_Desc_3               : 'Buka laman phicoinwallet.com bagian "Lihat Info Dompet" . ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim Ether menggunakan phicoinwallet CX? ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan phicoinwallet.com secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan phicoinwallet.com secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'phicoinwallet.com sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari phicoinwallet repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui phicoinwallet.com, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_1               : 'phicoinwallet bukan dompet web. Anda tidak memiliki login dan tidak ada yang bisa disimpan ke server kami. Ini hanyalah sebuah antarmuka yang memungkinkan Anda berinteraksi dengan blockchain. ',
HELP_8_Desc_2               : 'Jika situs phicoinwallet.com tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari phicoinwallet.com karena Ether Anda tidak disimpan di phicoinwallet.com. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan phicoinwallet CX. Dengan begitu, jika terjadi sesuatu pada phicoinwallet CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses Ether Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya phicoinwallet CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan phicoinwallet ke dalam geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Geth/Mist JSON yang dibuat dari phicoinwallet v2+.... ',
...
HELP_SecCX_Title            : 'Keamanan - phicoinwallet CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan phicoinwallet.com, bukan Chrome Extension ini. ',
...
HELP_Sec_Desc_2             : 'Kami sudah ada sejak 2015. Jika Anda mencari ["phicoinwallet" di reddit](https://www.reddit.com/search?q=phicoinwallet), Anda bisa melihat banyak orang yang sudah menggunakan layanan kami dan baik-baik saja. ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) ke [https://www.phicoinwallet.com](https://www.phicoinwallet.com). ',
