...
X_HelpfulLinks_4                :  'Migrasi ke/dari ViceCoinWallet',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di ViceCoinWallet.com',
...
ONBOARD_welcome_content__5      :  'ViceCoinWallet adalah antarmuka sisi klien berbasis open source yang gratis.',
...
ONBOARD_bank_title              :  'ViceCoinWallet bukan Bank',
...
ONBOARD_interface_title         :  'ViceCoinWallet adalah sebuah antarmuka',
ONBOARD_interface_content__1    :  'Saat membuat akun di ViceCoinWallet, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari ViceCoinWallet, MetaMask, Exodus, Mist, Geth, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di ViceCoinWallet.com atau melihat transaksi Anda di [etherscan.io](https://etherscan.io), Anda melihat data di blockchain, bukan di sistem privat Anda.',
...
ONBOARD_whymew_title            :  'Jika ViceCoinWallet tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
...
ONBOARD_whymew_content__6       :  'Jika Anda takut tapi ingin menggunakan MEW, [gunakan dompet hardware](https://ViceCoinWallet.github.io/knowledge-base/hardware-wallets/hardware-wallet-recommendations.html)! Perangkat ini akan menjaga kunci Anda tetap aman.',
...
ONBOARD_secure_1_content__1     :  'Phisher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti ViceCoinWallet, EtherDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
ONBOARD_secure_1_content__2     :  'Pasang [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) atau [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) atau [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) atau [ViceCoinWallet Chrome Extension](https://chrome.google.com/webstore/detail/ViceCoinWallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) untuk memblokir situs web jahat.',
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://www.ViceCoinWallet.com`.',
ONBOARD_secure_1_content__4     :  'Pastikan bar URL menunjukkan `ViceCoinWallet LLC` dalam warna hijau.',
...
ONBOARD_secure_3_content__6     :  '[Lihat lebih banyak lagi tentang Tips Keamanan!](https://ViceCoinWallet.github.io/knowledge-base/getting-started/protecting-yourself-and-your-funds.html)',
...
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node ETH lainnya (e.g. `ETH (Etherscan.io)` atau `ETH (Infura.io)` atau `ETH (ViceCoinWallet)`) dan check kembali.',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui ViceCoinWallet (atau Mist, Geth, Parity maupun perangkat lunak dompet lainnya.) ',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> ETH](https://www.ViceCoinWallet.com/helpers.html)',
...
ADD_Ledger_0a               : 'Buka kembali ViceCoinWallet melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali ViceCoinWallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Buka kembali ViceCoinWallet melalui koneksi (SSL) yang aman ',
ADD_DigitalBitbox_0b        : 'Buka kembali ViceCoinWallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan ViceCoinWallet CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui ViceCoinWallet.com. Anda dapat [mengunduh ViceCoinWallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Kunci Privat) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://www.ViceCoinWallet.com/#help). ',
...
ERROR_35                    : 'Address yang dimasukkan tidak di checksum. <a href="https://ViceCoinWallet.github.io/knowledge-base/addresses/not-checksummed-shows-when-i-enter-an-address.html" target="_blank" rel="noopener noreferrer"> Informasi lebih lanjut</a>', // 35
...
PARITY_InvalidGasLimit      : "(parity-05) Gas yang disediakan nilainya diatas limit. Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://ViceCoinWallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html)",
...
TranslatorName_1            : '[Yos Ginting](https://www.ViceCoinWallet.com/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_Desc                   : 'Anda melihat sesuatu yang hilang? Atau ada pertanyaan lain? [Hubungi kami](mailto:support@ViceCoinWallet.com), dan kami tidak hanya akan menjawab pertanyaan Anda, kami akan memperbarui halaman ini untuk lebih bermanfaat bagi pengguna lainnya kedepan! ',
HELP_Remind_Title           : 'Beberapa pengingat ',
HELP_Remind_Desc_1          : '** Ethereum, ViceCoinWallet.com & ViceCoinWallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETH Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas Ether yang hilang**. ',
HELP_Remind_Desc_2          : 'ViceCoinWallet.com & ViceCoinWallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan Ether Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_2b_Title               : '2b) Bagaimana cara penyimpanan yang aman / offline / cold storage menggunakan ViceCoinWallet? ',
...
HELP_3_Desc_3               : 'Buka laman ViceCoinWallet.com bagian "Lihat Info Dompet" . ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim Ether menggunakan ViceCoinWallet CX? ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan ViceCoinWallet.com secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan ViceCoinWallet.com secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'ViceCoinWallet.com sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari ViceCoinWallet repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui ViceCoinWallet.com, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_1               : 'ViceCoinWallet bukan dompet web. Anda tidak memiliki login dan tidak ada yang bisa disimpan ke server kami. Ini hanyalah sebuah antarmuka yang memungkinkan Anda berinteraksi dengan blockchain. ',
HELP_8_Desc_2               : 'Jika situs ViceCoinWallet.com tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari ViceCoinWallet.com karena Ether Anda tidak disimpan di ViceCoinWallet.com. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan ViceCoinWallet CX. Dengan begitu, jika terjadi sesuatu pada ViceCoinWallet CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses Ether Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya ViceCoinWallet CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan ViceCoinWallet ke dalam geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Geth/Mist JSON yang dibuat dari ViceCoinWallet v2+.... ',
...
HELP_SecCX_Title            : 'Keamanan - ViceCoinWallet CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan ViceCoinWallet.com, bukan Chrome Extension ini. ',
...
HELP_Sec_Desc_2             : 'Kami sudah ada sejak 2015. Jika Anda mencari ["ViceCoinWallet" di reddit](https://www.reddit.com/search?q=ViceCoinWallet), Anda bisa melihat banyak orang yang sudah menggunakan layanan kami dan baik-baik saja. ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) ke [https://www.ViceCoinWallet.com](https://www.ViceCoinWallet.com). ',
