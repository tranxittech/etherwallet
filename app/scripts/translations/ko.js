...
sidebar_donation            : 'phicoinwallet은 개인정보보호와 보안을 위한 무료 오픈 서비스입니다. 기부를 많이 받을수록 우리는 새로운 기능과 다양한 의견을 반영하여 사용자의 희망 사항을 위한 개발 시간을 늘리는 것이 가능해질 수 있습니다. 우리는 단 두명이 세상을 바꾸려 하고 있습니다. 도와주시겠습니까? ',
sidebar_donate              : '기부 ',
...
ADD_Ledger_0a               : 'phicoinwallet을 보안 연결(SSL)로 다시 연결해주세요. ',
ADD_Ledger_0b               : 'phicoinwallet을 [Chrome](https://www.google.com/chrome/browser/desktop/) 또는 [Opera](https://www.opera.com/) 브라우저로 다시 열어주세요. ',
...
ADD_DigitalBitbox_0a        : 'phicoinwallet을 보안 연결(SSL)로 다시 연결해주세요. ',
ADD_DigitalBitbox_0b        : 'phicoinwallet을 [Chrome](https://www.google.com/chrome/browser/desktop/) 또는 [Opera](https://www.opera.com/) 브라우저로 다시 열어주세요. ',
...
MYWAL_Content_3             : '나중에 이 지갑을 phicoinwallet CX와 같이 사용하려면, 개인 키/JSON과 비밀번호를 이용하여 수동으로 다시 추가해야 합니다. ',
...
TRANS_data                  : '데이터 ',
TRANS_gas                   : '가스 한도 ',
TRANS_sendInfo              : '21000 가스를 사용하는 표준 트랜잭션은 0.000441 ETH 를 사용합니다. 우리는 최소 가스 가격인 0.000000021 보다 약간 높게 책정하여 전송을 빠르게 합니다. phicoinwallet은 트랜잭션 수수료를 얻지 않습니다. ',
...
NODE_Warning                : 'phicoinwallet.com을 통해 연결하기 위해서는 HTTPS 노드가 필요합니다. 모든 노드에 연결하려면 [phicoinwallet 저장소를 다운로드하고 로컬로 실행] (https://github.com/kvhnuke/etherwallet/releases/latest) 할 수 있습니다. 추가로 무료 SSL 인증서를 [LetsEncrypt](https://letsencrypt.org/)에서 받으실 수 있습니다. ',
NODE_Name                   : '노드 명 ',
NODE_Port                   : '노드 포트 ',
...
ERROR_28                    : '지갑에 액세스하기 위해서는 **Keystore 파일과 비밀번호** (또는 개인키)가 필요합니다. 별도로 저장하여 백업해주세요. 만약 그것을 저장하지 않으면 지갑을 복원할 방법이 없습니다. 자세한 내용은 [도움말 페이지](https://www.phicoinwallet.com/#help)를 참고해주세요. ',
...
TranslatorName_1            : '[CoinKorea](https://www.phicoinwallet.com/?gaslimit=21000&to=0x0080782b9A9A14f7871Bb765eF7041e784D03F00&value=1.0#send-transaction) · [kanghamin](https://www.phicoinwallet.com/?gaslimit=21000&to=0x7B12655A5aada0b3c053C7ff5aa444Bd666A0163&value=1.0#send-transaction) · [maa](https://www.phicoinwallet.com/?gaslimit=21000&to=0x14036e41ddb2bd408eaf91597e6dc5220f776ae0&value=1.0#send-transaction) ',
TranslatorAddr_1            : '0x0080782b9A9A14f7871Bb765eF7041e784D03F00 ',
/* Translator 1             : Insert Comments Here */
TranslatorName_2            : '· [Issac](https://www.phicoinwallet.com/?gaslimit=21000&to=0x594a7773f4e062ccf644e8f122d5612b5f0db3b2&value=1.0#send-transaction) ',
TranslatorAddr_2            : '0x594a7773f4e062ccf644e8f122d5612b5f0db3b2 ',
/* Translator 2             : Insert Comments Here */
TranslatorName_3            : '· [coinmaker](https://www.phicoinwallet.com/?gaslimit=21000&to=0x80B65285607BAbC4b60a7179A0fa8EB42232b9ad&value=1.0#send-transaction) ',
TranslatorAddr_3            : '0x80B65285607BAbC4b60a7179A0fa8EB42232b9ad ',
/* Translator 3             : Insert Comments Here */
TranslatorName_4            : '· [csjune](https://www.phicoinwallet.com/?gaslimit=21000&to=0xfc465E0545c1024d04ceA2d6D154F20E7C67C66f&value=1.0#send-transaction) ',
TranslatorAddr_4            : '0xfc465E0545c1024d04ceA2d6D154F20E7C67C66f ',
/* Translator 4             : Insert Comments Here */
TranslatorName_5            : '· [sadfrog](https://www.phicoinwallet.com/?gaslimit=21000&to=0x608c96865c3d1364ffc5137e5ac78b57e58714d4&value=1.0#send-transaction) ',
...
HELP_Desc                   : '잘못된 부분이나 다른 질문이 있으신가요? [우리에게 연락해주세요] (mailto : support@phicoinwallet.com), 당신의 질문에 답변하는 것 뿐만 아니라, 향후 사용자들에게 더 유용할 수 있도록 페이지를 업데이트할 것입니다. ',
HELP_Remind_Title           :  '몇 가지 알림 ',
HELP_Remind_Desc_1          : '**이더리움, phicoinwallet.com & phicoinwallet CX, 그리고 우리가 사용하는 JavaScript 라이브러리는 활발하게 개발되고 있습니다. ** 우리가 철저하게 테스트를 진행하여 수만 개의 지갑이 전 세계 사람들에 의해 성공적으로 만들어졌지만 예상치 못한 일이 발생하여 ETH를 잃을 가능성이 항상 존재합니다. 항상 조심해주세요. 만약 무슨 일이 발생한다면, 유감스럽지만 **우리는 잃어버린 이더리움에 대한 책임을 지지 않습니다.** ',
HELP_Remind_Desc_2          : 'phicoinwallet.com 과 phicoinwallet CX는 웹 지갑이 아닙니다. 계정을 만들거나 우리에게 당신이 가진 이더리움을 주면 안 됩니다. 모든 데이터는 당신의 컴퓨터와 브라우저에 남아 있을 것입니다. 우리는 당신이 쉽게 당신의 정보를 만들고, 저장하고, 접근하고 블록체인과 상호 작용할 수 있도록 도울 것입니다. ',
...
HELP_0_Desc_1               : 'phicoinwallet은 새로운 지갑을 생성할 수 있는 기능을 제공하므로 거래소에 이더리움을 두지 않고 직접 저장할 수 있습니다. 이 과정은 전적으로 당신의 컴퓨터에서 발생하고 우리의 서버에서 발생하지 않습니다. 따라서 새로운 지갑을 만들 때 **안전하게 백업’해야 합니다**. ',
...
HELP_2b_Title               : '2b) 어떻게 하면 phicoinwallet을 이용해 안전하게 오프라인, 콜드 스토리지로 자산을 보관할 수 있나요?  ',
...
HELP_3_Desc_3               : 'phicoinwallet.com 에서 "지갑 정보 보기" 페이지로 이동합니다. ',
...
HELP_3_Desc_8               : '많은 양의 이더리움을 phicoinwallet 으로 전송하기 전에, 소량의 이더리움을 전송해 보는 것을 권장합니다. 0.001 이더리움을 지갑으로 전송하고, 지갑을 열어 받은 이더리움을 확인하고, 다시 0.001 이더리움을 다른 주소로 전송하여 모든 과정이 잘 작동하는지 확인해주세요. ',
...
HELP_4CX_Title              : '4) 이더리움을 phicoinwallet CX를 사용하여 전송하는 방법이 궁급합니다. ',
...
HELP_5_Title                : '5) phicoinwallet.com 을 오프라인/로컬에서 사용할 수 있나요?  ',
HELP_5_Desc_1               : 'phicoinwallet을 GitHub 서버가 아닌 본인의 컴퓨터에서 이용할 수 있습니다. 오프라인 상태에서 지갑을 생성할 수 있으며, "오프라인 트랜잭션" 페이지에서 트랜잭션을 전송할 수 있습니다. ',
HELP_5_Desc_7               : 'phicoinwallet.com 은 이제 본인의 컴퓨터에서 구동됩니다. ',
HELP_5_Desc_8               : '아직 사용이 미숙할 때는, ‘index.html’ 뿐만 아니라 웹사이트를 가동하는 전체 폴더를 수정하지 말아 주세요. ',
HELP_5_Desc_9               : '우리는 phicoinwallet.com을 주기적으로 업데이트하고 있으므로 당신이 정기적으로 저장소의 업데이트된 버전을 사용하는 것을 권장합니다. ',
...
HELP_8_Title                : '8) phicoinwallet 서버가 다운되면 어떻게 되나요? ',
HELP_8_Desc_1               : 'phicoinwallet은 웹 지갑이 아닙니다. 서버에는 로그인은 물론 어떠한 것도 저장되지 않습니다. phicoinwallet은 단지 블록체인에 접근 하게 해주는 도구입니다. ',
HELP_8_Desc_2               : '만약 phicoinwallet.com 이 다운된다면, 다른 대안 도구 (geth 또는 Ethereum Wallet / Mist 등)을 사용해야 합니다. phicoinwallet 에서 이더리움을 꺼내야 할 필요는 없습니다. 이더리움들은 phicoinwallet.com 을 통해서 생성된 지갑 내에 존재합니다. ',
HELP_8_Desc_3               : '암호화되지 않은 개인 키와 암호화된 Geth/Mist 형식의 파일은 쉽게 geth / 이더리움 지갑 / Mist에서 불러올 수 있습니다. 아래의 질문 #12를 확인해주세요. ',
HELP_8_Desc_4               : '또한, phicoinwallet 이 다운 될 가능성은 희박합니다. 우리는 어떠한 정보도 저장하지 않기 때문에 비용이 들지 않습니다. 도메인이 다운되더라도, 항상 공개적으로  [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages)을 통해 로컬 지갑을 시작할 수 있습니다. ZIP 파일을 다운 받아주세요. ',

HELP_8CX_Title             : '8) phicoinwallet CX가 사라지면 어떻게 되나요? ',
HELP_8CX_Desc_1             : '우선, 모든 정보는 phicoinwallet 서버가 아닌 사용자의 컴퓨터에 저장됩니다. 오해할 수도 있지만, Chrome 확장 프로그램 화면은 우리의 서버에서 불러온 것이 아닙니다. 전부 사용자의 컴퓨터에 저장 되어있습니다. ',
HELP_8CX_Desc_2             : '즉, **매우 중요** phicoinwallet CX 로 새로 만든 지갑 정보는 모두 백업해 두어야 합니다. 만약 컴퓨터에 문제가 생기거나 Chrome 확장 프로그램에 문제가 생겨도 백업해둔 파일로 지갑에 접근할 수 있습니다. #2a에서 지갑을 어떻게 백업 하는 지 확인할 수 있습니다. ',
HELP_8CX_Desc_3             : '어떤 이유로 phicoinwallet CX 가 Chrome 스토어에서 사라져도, Github 에서 소스를 다운 받아 수동으로 사용할 수 있습니다. 위의 #5를 확인해주세요. ',
...
HELP_12_Title               : '12) phicoinwallet으로 만든 지갑을 geth / 이더리움 지갑 / Mist로 가져오려면 어떻게 해야 하나요? ',
HELP_12_Desc_1              : 'phicoinwallet v2 +의 Geth / Mist JSON 파일 사용하기… ',
...
HELP_SecCX_Title            : '보안 - phicoinwallet CX ',
...
HELP_SecCX_Desc_6           : '닉네임과 지갑 주소를 암호화하면 계좌 잔액과 닉네임들을 확인할 때마다 비밀번호를 입력해야 합니다. 보안이 걱정된다면 Chrome 확장 프로그램 대신 phicoinwallet.com 을 사용해주세요. ',

HELP_Sec_Title              : '보안 ',
HELP_Sec_Desc_1             : '당신의 첫 번째 질문이 "이 사람들을 신뢰할 수 있나요?"라는 질문이라면 매우 타당한 질문입니다. 다음 내용이 당신의 질문에 대한 답변이 되기를 바랍니다. ',
HELP_Sec_Desc_2             : '우리는 2015년 8월부터 운영되어 왔습니다. [www.reddit.com 에서 phicoinwallet](https://www.reddit.com/search?q=myetherwalle)을 검색하면 많은 사용자들을 볼 수 있습니다. ',
...
HELP_Sec_Desc_4             : '이 URL을 확인해보세요. -- 이 사이트는 GitHub를 통해 소스가 공개되어 있으며 다음 링크에서 확인하실 수 있습니다. : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://www.phicoinwallet.com](https://www.phicoinwallet.com). ',
