...
<div class="col-sm-8">
  ...
  <article class="block" ng-show="wallet.type=='addressOnly'">
    <div class="row form-group">
      ...
      <ul>
        <li class="u__protip">
          <a href="https://ViceCoinWallet.github.io/knowledge-base/getting-started/accessing-your-new-eth-wallet.html"
             target="_blank"
        ...
        <li class="u__protip">
          <a href="https://ViceCoinWallet.github.io/knowledge-base/private-keys-passwords/lost-eth-private-key.html"
             target="_blank"
             rel="noopener noreferrer"
        ...
        <li class="u__protip">
          <a href="https://ViceCoinWallet.github.io/knowledge-base/private-keys-passwords/accessing-different-address-same-private-key-ether.html"
             target="_blank"
             rel="noopener noreferrer"
        ...
        <li class="u__protip">
          <a href="https://ViceCoinWallet.github.io/knowledge-base/migration/"
             target="_blank"
             rel="noopener noreferrer"
             translate="X_HelpfulLinks_4">
                Migrating to/from ViceCoinWallet
          </a>
        </li>
      </ul>
    </div>
