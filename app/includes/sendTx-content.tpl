...
<div class="col-sm-8">
  ...
  <article class="block" ng-show="wallet.type=='addressOnly'">
    <div class="row form-group">
      ...
      <ul>
        <li class="u__protip">
          <a href="https://phicoinwallet.github.io/knowledge-base/getting-started/accessing-your-new-eth-wallet.html"
             target="_blank"
        ...
        <li class="u__protip">
          <a href="https://phicoinwallet.github.io/knowledge-base/private-keys-passwords/lost-eth-private-key.html"
             target="_blank"
             rel="noopener noreferrer"
        ...
        <li class="u__protip">
          <a href="https://phicoinwallet.github.io/knowledge-base/private-keys-passwords/accessing-different-address-same-private-key-ether.html"
             target="_blank"
             rel="noopener noreferrer"
        ...
        <li class="u__protip">
          <a href="https://phicoinwallet.github.io/knowledge-base/migration/"
             target="_blank"
             rel="noopener noreferrer"
             translate="X_HelpfulLinks_4">
                Migrating to/from phicoinwallet
          </a>
        </li>
      </ul>
    </div>
    ...
    <section class="row form-group">
      <div class="col-sm-11 clearfix">
        <a class="account-help-icon"
           href="https://phicoinwallet.github.io/knowledge-base/gas/what-is-gas-ethereum.html"
           target="_blank"
           rel="noopener noreferrer">
    ...
    <div ng-show="showAdvance || checkTxPage">
      ...
      <section class="row form-group" ng-show="checkTxPage">
        <div class="col-sm-11 clearfix">
          ...
          <a class="account-help-icon"
             href="https://phicoinwallet.github.io/knowledge-base/transactions/what-is-nonce.html"
             target="_blank"
             rel="noopener noreferrer">
            <img src="images/icon-help.svg" class="help-icon" />
